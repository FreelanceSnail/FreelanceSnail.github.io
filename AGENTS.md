...
- Pages live at the root (`index.md`, `about.md`, `blog.md`, `dashboard.md`, `404.html`); blog posts live in `_posts/` using Jekyll’s `YYYY-MM-DD-title.md` pattern (lowercase, hyphenated slugs). Lab pages live under `lab/` (example: `lab/momentum-rotation.md`).
